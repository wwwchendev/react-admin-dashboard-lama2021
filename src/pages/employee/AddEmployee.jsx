...
const AddEmployee = props => {
  const {
    showAddEmployeeModalElement,
    handleAddEmployeeFormChange,
    handleAddEmployeeFormSubmit,
    formData,
    submitClicked,
    promptMessage,
    employeeIsActiveRadioChecked,
    employeeRoleRadioChecked,
  } = props;
  //Redux
    ...
    <>
      <FormWrapper>
        ...
        <FormBody>
          ...
          <pre><Span>{JSON.stringify(formData, null, 2)}</Span></pre>          <pre><Span>{JSON.stringify(employeeState.error, null, 2)}</Span></pre></FormSide> */}
        </FormBody>
          ...
          {!submitClicked && employeeState.error === null ? (
            <>
              <Button
                ...
                $color={'#333'}
                onClick={() => {
                  showAddEmployeeModalElement(false);
                }}
              >
                取消
              </Button>
              <Button
                ...
                onClick={handleAddEmployeeFormSubmit}
