...
const Delivering = props => {
  ...
  const handleFormSubmit = async e => {
    ...
    if (deliveringDate !== '' && deliveringTime !== '') {
      setSubmitClicked(true);
      setOperateType('delivering');
      const newData = {
        status: '待取貨',
        logisticHistory: [
          ...currentData.logisticHistory,
          {
            time: convertIsoToTaipei(
              new Date(`${deliveringDate}T${deliveringTime}:00.000Z`),
            ),
            actionType: '送達',
      ...
      alert('送達日期,送達時間等欄位不得為空');
    }
  };
  return (
    <>
      <FormWrapper>
        <FormTitle $margin={'0 0 0.75rem 0'}>貨物送達</FormTitle>
              ...
              <FormCol $minWidth={'4rem'}>
                ...
                <InputWrapper>
                  <Input
                    type='date'
                    name='deliveringDate'
                    value={modalFormData.deliveringDate}
                    onChange={handleFormChange}
                ...
                <InputWrapper>
                  <Input
                    type='time'
                    name='deliveringTime'
                    value={modalFormData?.deliveringTime}
                    onChange={handleFormChange}
                    disabled={submitClicked && !logisticState.error}
                  />
                </InputWrapper>
